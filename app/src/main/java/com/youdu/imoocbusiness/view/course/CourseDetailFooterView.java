package com.youdu.imoocbusiness.view.course;
...
import com.youdu.imoocbusiness.module.course.CourseFooterDateValue;
import com.youdu.imoocbusiness.module.course.CourseFooterRecommandValue;
import com.youdu.imoocbusiness.module.course.CourseFooterValue;
import com.youdu.yonstone_sdk.adutil.DateFormatHelper;
        ...
        for (int i = 0; i < mFooterValue.recommand.size(); i++) {
            ...
            mImageViews[i].setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mContext.startActivity(CourseDetailActivity.actionView(mContext, value.courseId));
                }
            });
